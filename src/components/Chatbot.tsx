    ...
    return (
        <>
            ...
            <div
                ...
                className={`fixed inset-0 z-40 transition-opacity duration-200 ${open
            ...
            <div className="fixed bottom-6 right-6 z-50">
                <div
                    className={`flex flex-col transition-all duration-200 ${open ? "w-[calc(100%-2rem)] sm:w-[22rem] md:w-[26rem]" : "w-14"
                        }`}
                    aria-live="polite"
                >
                    {/* launcher / header */}
                    <div
                        className={`flex items-center justify-between rounded-full shadow-lg p-2 space-x-2 ${open ? "bg-white dark:bg-gray-900 border dark:border-gray-700" : "bg-indigo-600"
                            }`}
                    >
                        <button
                            aria-label={open ? "Close chat" : "Open chat"}
                            onClick={() => setOpen((s) => !s)}
                            className={`flex items-center gap-2 px-3 py-2 rounded-full focus:outline-none focus:ring-2 focus:ring-indigo-400 ${open ? "bg-transparent text-gray-900 dark:text-gray-100" : "text-white"
                                }`}
                        ...
                        <button
                            aria-label="Close"
                            onClick={() => setOpen(false)}
                            className={`p-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800 focus:outline-none ${open ? "" : "hidden"
                                }`}
                        >
                            <X className="w-4 h-4" />
                        </button>
                                ...
                                {messages.map((m, idx) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div
                                                className={`px-3 py-2 rounded-lg max-w-[84%] break-words text-sm leading-relaxed ${isBot
